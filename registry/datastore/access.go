...
type Access interface {
	OrganizationAdd(ctx context.Context, pTx pgx.Tx, name, url, publicKey string) (item *entity.Organization, err error)
	OrganizationUpdate(ctx context.Context, pTx pgx.Tx, item *entity.Organization, name, url, publicKey string) (err error)
